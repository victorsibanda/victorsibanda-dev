...
window.PORTFOLIO = {
  ...
  interests: [
    { tag: '01', icon: 'code',   title: 'Platform Craft',  body: 'IaC with CDK and Terraform, container orchestration, pipelines that don\'t wake you up at 3am.' },
    { tag: '02', icon: 'game',   title: 'Gamer',           body: 'Assassin\'s Creed, GTA, anything with a map worth losing hours in.' },
    { tag: '03', icon: 'anime',  title: 'Anime',           body: 'DBZ, Naruto, Bleach, One Piece — and Death Note when I want it darker.' },
    { tag: '04', icon: 'gym',    title: 'Gym',             body: 'Training like a Saiyan most mornings. Progress over perfection.' },
    { tag: '05', icon: 'family', title: 'Family',          body: 'Husband and new dad. The real end-boss fight — and I love every minute.' },
    { tag: '06', icon: 'faith',  title: 'Faith',           body: 'Christian. Steadfastness through trials — keeps the north star clear.' },
    { tag: '07', icon: 'learn',  title: 'Learning',        body: 'Always a new cert, service, or rabbit-hole. Curiosity is the engine.' },
    { tag: '08', icon: 'music',  title: 'Build Mode',      body: 'Hip-hop, lo-fi, and anime OSTs on loop while I ship.' }
  ],
  ...
  contact: [
    { lbl: 'Email',    val: 'hello@victorsibanda.dev',              href: 'mailto:hello@victorsibanda.dev',                       icon: 'mail'     },
    { lbl: 'LinkedIn', val: 'linkedin.com/in/victor-s-1389a5121',   href: 'https://www.linkedin.com/in/victor-s-1389a5121',        icon: 'linkedin' },
    { lbl: 'GitHub',   val: 'github.com/victorsibanda',             href: 'https://github.com/victorsibanda',                     icon: 'github'   }
  ],

  verse: '"Count it all joy, my brothers, when you meet trials of various kinds, for you know that the testing of your faith produces steadfastness." — James 1:2–4'
};
